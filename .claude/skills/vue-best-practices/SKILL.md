...
description: Vue 3.5 + TypeScript CODE-MECHANICS best practices — component typing, tooling, and reactivity idioms. Use when writing or refactoring Vue 3 components with TypeScript, configuring Volar/vueCompilerOptions/strictTemplates, extracting component types, working with defineModel/withDefaults/useTemplateRef/onWatcherCleanup/deep watch/reactive props destructure, typing vue-router params, or debugging vue-tsc/Volar tooling. Triggers on Vue components, props extraction, wrapper components, template type checking, strictTemplates, vueCompilerOptions, Volar 3, CSS modules, fallthrough attributes, defineModel, withDefaults, deep watch, vue-router typed params, HMR SSR, moduleResolution bundler, useTemplateRef, onWatcherCleanup, useId, generic components, reactive props destructure. NOT UI styling/tokens (that's vuetify-ds), NOT accessibility/interface review (that's web-design-guidelines), and NOT writing tests.
license: MIT
metadata:
  author: ejirocodes
  version: 1.0.0
