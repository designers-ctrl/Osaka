...
export const GRAPH_DOCUMENT_HUBS = [
  { id: 'doc-atlas', x: 180, y: 90, satellites: 3, radius: 40 },
  { id: 'doc-genesis', x: 550, y: 90, satellites: 3, radius: 40 },
  { id: 'doc-operating-model', x: 700, y: 120, satellites: 3, radius: 40 },
  { id: 'doc-annual', x: 80, y: 200, satellites: 3, radius: 40 },
  { id: 'doc-legalfab', x: 610, y: 200, satellites: 3, radius: 40 },
  { id: 'doc-partnership', x: 690, y: 330, satellites: 3, radius: 40 },
  { id: 'doc-pilot', x: 210, y: 390, satellites: 3, radius: 40 },
  { id: 'doc-ip', x: 630, y: 430, satellites: 3, radius: 40 },
  { id: 'doc-operating-agr', x: 160, y: 510, satellites: 3, radius: 40 },
  { id: 'doc-northwind', x: 670, y: 530, satellites: 3, radius: 40 },
  { id: 'doc-annual-report', x: 50, y: 50, satellites: 4, radius: 40 },
  { id: 'doc-atlas-status', x: 120, y: 40, satellites: 4, radius: 40 },
] as const
...
export const GRAPH_CONNECTIONS = [
  ...
  // Insight-to-insight connections
  { source: 'ins-owner-gap', target: 'ins-quiet' },
  { source: 'ins-deal-velocity', target: 'ins-intro-path' },
  { source: 'ins-valuation', target: 'ins-runway' },
